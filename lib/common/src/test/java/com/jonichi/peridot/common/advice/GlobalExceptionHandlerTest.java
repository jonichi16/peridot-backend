...
public class GlobalExceptionHandlerTest {
    ...
    @Test
    public void handleUsernameNotFoundException_shouldReturnBadRequestError() throws Exception {
        // given
        UsernameNotFoundException exception = new UsernameNotFoundException("Invalid username or password");

        // when
        ResponseEntity<ApiResponse<Void>> response = globalExceptionHandler.handleUsernameNotFound(exception);
